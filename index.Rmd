...
You need to install - but only once - the [tidyverse](https://www.tidyverse.org/) package and load it into your R session. ggplot2 is part of the tidyverse suite of R tools for data science.
```{r}
